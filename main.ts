...
scene.setBackgroundImage(img`
    ...
    bbbcdddddbbbbccccccccccccbbbbbbccccbbcbccccccccccccbcccccccccccccccccccccbcbbbbbbbcccccccccccccccccbbbbbbcccccbbbbbbbbbbcccccccccccccccccccbbbbbbbbbbbbbbbbbbbbb
    ...
    `)
let picallo = sprites.create(assets.image`piclloo thomas`, SpriteKind.character)
picallo.setPosition(115, 49)
picallo.sayText("hi i)m piclloo")
let dino2 = sprites.create(assets.image`npooooooooooooooooooooooooooolllllooooooooooooooooooooooooooooooooooolllloooooooooooooooooooooooooooooooooooooollllooooooooooooooooooooooooo90po`, SpriteKind.Player)
dino2.setPosition(21, 95)
dino2.sayText("hi")
